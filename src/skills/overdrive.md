---
name: overdrive
description: Push a design past conventional limits with ambitious, technically extraordinary visual effects.
args:
  - name: target
    description: The feature or component to push (optional)
    required: false
user-invokable: true
---
...
2. **STOP and {{ask_instruction}} to clarify.** Present these directions and get the user's pick before writing any code. Explain trade-offs (browser support, performance cost, complexity).
